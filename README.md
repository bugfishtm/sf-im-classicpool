...
A JavaScript 8-ball pool game by Chen Shmilovich (2018), now with a TypeScript remake available at https://github.com/henshmi/Classic-8-Ball-Pool. Play against friends or AI with various difficulty levels. Controls: 'W' to increase shot power, 'S' to decrease, 'Esc' to return to menu, left click to shoot, and aim with mouse movement. Try the demo at https://henshmi.github.io/Classic-Pool-Game/. Built using techniques from "Building JavaScript Games" by Arjan Egges, LAB.js library, and features music by Kevin MacLeod (Bossa Antigua) under Creative Commons Attribution 3.0 License.
